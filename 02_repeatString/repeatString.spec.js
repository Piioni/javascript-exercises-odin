...
describe('repeatString', () => {
  ...
  test('repeats the string a random amount of times', function () {
    ...
    0 and 1, when this is multiplied by 1000 and rounded down with Math.floor it
    equals a number between 0 and 999 (this number will change everytime you run
    the test).*/
    ...
    in the result, which is your function works correctly will equal the number that
